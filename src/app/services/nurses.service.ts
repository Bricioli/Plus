...
export class NursesService {
  ...
  update(id: string, name: string, birthday: string, cpf : string, coren : string, adress : string, phone : string, email : string, pix : string, receive : number, obs : string) {
    return this.httpClient.put(this.apiUrl + "/nurse-update" , { id, name, birthday, cpf, coren, adress, phone, email, pix, receive, obs})
  }
}
